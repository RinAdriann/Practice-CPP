...
int main(){
//Find The Factors from A Quadratic Equation
    int a, b, c;
    cin >> a >> b >> c;
    double det, x1, x2;
...
//Outputs How Many Days in a Month(using if-conditional)
    int m;
...
//Outputs How Many Days in a Month(using switch-case)
switch(m){
        case 1:
...
//Check Whether The Input Num is an Integer or Not
    long double x;
    long int y;
    cin >> x;
    y = x;
